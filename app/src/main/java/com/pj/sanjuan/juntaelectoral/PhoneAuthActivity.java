...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    private void startPhoneNumberVerification(String phoneNumber) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                "+54" + phoneNumber,        // Phone number to verify
                60,                 // Timeout duration
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            myRef.child("users").child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot snapshot) {
                                    if (snapshot.getValue() != null) {
                                        ...
                                        Intent y = new Intent(PhoneAuthActivity.this, IndexActivity.class);
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                // [START_EXCLUDE silent]
                                mVerificationField.setError("Código incorrecto.");
                                // [END_EXCLUDE]
                            }
                            // [START_EXCLUDE silent]
                            // Update UI
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                Toast.makeText(PhoneAuthActivity.this, "Mensaje enviado", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_FAILED:
                ...
                Toast.makeText(PhoneAuthActivity.this, "Verificación erronea", Toast.LENGTH_LONG).show();
                break;
            case STATE_VERIFY_SUCCESS:
                ...
                Toast.makeText(PhoneAuthActivity.this, "Verificación exitosa", Toast.LENGTH_LONG).show();
    ...
    private boolean validatePhoneNumber() {
        ...
        if (TextUtils.isEmpty(phoneNumber)) {
            mPhoneNumberField.setError("Ingrese un número de celular válido.");
            return false;
        }
